...
extern proximityMonitorContext_Type proximityMonitorContext;
 ...
 * PXM_Clear_Security_Database()  
 * @retval Status of call
 */
uint8_t PXM_Clear_Security_Database(void);
 ...
 * @retval Status of call
 */
uint8_t PXM_GetRSSI(uint8_t *value);
