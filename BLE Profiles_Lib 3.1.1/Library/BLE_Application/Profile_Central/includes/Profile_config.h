...
#define NUM_APP_GATT_SERVICES   (3)  //TBR
#define NUM_APP_GATT_ATTRIBUTES (28) //TBR
...
/* Number of GATT attributes needed for the  profile central demo. */
#define NUM_GATT_ATTRIBUTES     (DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the profile central demo. */
