...
#define PEER_ADDRESS  {0x23, 0x02, 0x00, 0xE1, 0x80, 0x02} 
...
#define TIME_CLIENT_SC_SUPPORT                          SC_IS_SUPPORTED   
#define TIME_CLIENT_KEYPRESS_NOTIFICATION_SUPPORT       KEYPRESS_IS_NOT_SUPPORTED
#define TIME_CLIENT_IDENTITY_ADDRESS_TYPE               0x00   
