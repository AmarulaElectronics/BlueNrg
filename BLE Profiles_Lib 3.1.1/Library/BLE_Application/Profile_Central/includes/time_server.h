...
* Macro Declarations
******************************************************************************/
/* Number of virtual timer used to track delay between successive  
   current time updates with notification */
#define DELAY_TIMER                 1
/* Number of virtual timer used to reference time update*/
#define REFERENCE_TIMER             2
...
#define DELAY_UPDATE_TIMEOUT		          (900)  /* 15 minutes */
...
typedef struct TimeServerContextS {
  ...
  /**
   * handle of Reference Time Update service (RTUS)
   */ 
...
/**
  ...
  */
tBleStatus TimeServer_Clear_Security_Database(void);
 ...
 * @retval None
 */ 
tBleStatus TimeServer_Allow_Curtime_Char_Read(void);//TBR
