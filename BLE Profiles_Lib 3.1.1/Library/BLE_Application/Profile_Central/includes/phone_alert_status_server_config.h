...
#define PTS_PERIPHERAL_ADDRESS {0x97, 0x2F, 0x07, 0xdc, 0x1b, 0x00}  //{0x00, 0x1B, 0xDC, 0x06, 0x06, 0x44} 
...
#define PASS_SC_SUPPORT                         SC_IS_SUPPORTED   
#define PASS_KEYPRESS_NOTIFICATION_SUPPORT      KEYPRESS_IS_NOT_SUPPORTED
#define PASS_IDENTITY_ADDRESS_TYPE              0x00   
