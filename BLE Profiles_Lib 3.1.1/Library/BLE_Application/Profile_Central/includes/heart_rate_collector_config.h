...
#define PTS_PERIPHERAL_ADDRESS {0x97, 0x2F, 0x07, 0xdc, 0x1b, 0x00}  // {0x97, 0x2F, 0x07, 0xdc, 0x1b, 0x00} {0x44, 0x06, 0x06, 0xdc, 0x1b, 0x00} 

/* Expected Peer Address if any */
#define PEER_ADDRESS {0x23, 0x02, 0x00, 0xE1, 0x80, 0x02} //{0xdd, 0x00, 0x00, 0xE1, 0x80, 0x02};  //{0xfd, 0x00, 0x25, 0xec, 0x02, 0x04} //TBR

/******************** Device Init Parameters *******************/

#define HRC_PUBLIC_ADDRESS         {0x22, 0x02, 0x00, 0xE1, 0x80, 0x02} //{0x22, 0x02, 0x00, 0xE1, 0x80, 0x02}//{0xFC, 0x12, 0x00, 0xE1, 0x80, 0x02} //{0x22, 0x02, 0x00, 0xE1, 0x80, 0x02}
...
#define HRC_SC_SUPPORT                          SC_IS_SUPPORTED 
#define HRC_KEYPRESS_NOTIFICATION_SUPPORT       KEYPRESS_IS_NOT_SUPPORTED
#define HRC_IDENTITY_ADDRESS_TYPE               0x00     
