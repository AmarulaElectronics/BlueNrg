...
#define PTS_PERIPHERAL_ADDRESS {0x97, 0x2F, 0x07, 0xdc, 0x1b, 0x00} //{0x44, 0x06, 0x06, 0xdc, 0x1b, 0x00} // {0x33, 0x33, 0x07, 0xdc, 0x1b, 0x00} 

/******************** Device Init Parameters *******************/

#define PM_PUBLIC_ADDRESS          {0x22, 0x02, 0x00, 0xE1, 0x80, 0x02} //{0x88, 0x55, 0x44, 0x33, 0x22, 0x11}
...
#define PM_FIXED_PIN                            111111
#define PM_BONDING_MODE                         BONDING
#define PM_SC_SUPPORT                           SC_IS_SUPPORTED   
#define PM_KEYPRESS_NOTIFICATION_SUPPORT        KEYPRESS_IS_NOT_SUPPORTED
#define PM_IDENTITY_ADDRESS_TYPE                0x00   
