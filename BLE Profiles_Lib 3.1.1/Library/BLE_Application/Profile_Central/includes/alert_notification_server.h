...
/**
  ...
  */
tBleStatus ANS_Clear_Security_Database(void);
 ...
 * @return:  status
 */ 
tBleStatus ANS_Handle_ControlPoint_Write(uint8_t *attVal);
 ...
 * @retval None
 */
extern void ANS_Attribute_Modification_Received_CB(uint8_t handle, uint8_t length, uint8_t * data_value); 
 ...
 * @retval None
 */
extern void ANS_Received_Control_Point_Command_CB(uint8_t * command_value);
#endif
