...
#define TIME_SERVER_SC_SUPPORT                          SC_IS_SUPPORTED   
#define TIME_SERVER_KEYPRESS_NOTIFICATION_SUPPORT       KEYPRESS_IS_NOT_SUPPORTED
#define TIME_SERVER_IDENTITY_ADDRESS_TYPE               0x00 
