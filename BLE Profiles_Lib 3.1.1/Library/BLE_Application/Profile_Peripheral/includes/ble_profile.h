...
/* Added PID for CGM sensor profile role */
#define PID_CGM_SENSOR		                           (0x10)
 ...
 * every profile has to register with the main
 * profile
 */ 
typedef struct _tProfileInterfaceContext
{
     ...
     * for internal usage
     */ 
    tListNode currentNode;   //it isn't really used
